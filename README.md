...
- Anticipating a higher sale price for a house would fail to attract potential customers, ultimately resulting in losses for the company.
- Foreseeing a lower sale price for a house would result in a decreased profit margin for the company.v
...
<ol>
    ...
    <li>Data Preparation</li>
      <ol>
        ...
        <li>Perform Std Scaling.</li>
        <li>Divide data into Predictor & Target variables.</li>
      </ol>
    <li>Data Modelling & Evaluation</li>
      <ol>
        <li>Create Linear Regression model using RFE</li>
        <li>Create Lasso and Ridge Regularized Models using the output of the RFE</li>
